    ...
    <nav className="navbar navbar-expand-lg navbar-light container-fluid pr-4 pl-4">
      ...
      <div className="collapse navbar-collapse " id="navbarSupportedContent">
        <ul className="navbar-nav ml-auto ">
          ...
          {!loggedInUser.email ? (
            false
          ) : true && loggedInUser.adminEmail ? (
            <li className="nav-item active">
              <Link className="nav-link mr-3" to="/admin">
                {" "}
                Admin{" "}
              </Link>
            </li>
            ...
            <li className="nav-item active">
              <Link className="nav-link mr-3" to="/orderList">
                {" "}
                Order{" "}
              </Link>
            </li>
          ...
          {!loggedInUser.email && (
            <li className="nav-item active">
              <Link className="nav-link mr-3 button-primary " to="/login">
                {" "}
                Login{" "}
              </Link>
            </li>
