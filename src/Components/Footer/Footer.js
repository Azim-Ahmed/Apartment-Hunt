...
const Footer = () => {
  const noNamed = [
    {
      name:
        "H#340 (4th Floor), Road #24, New DOHS, Mohakhali, Dhaka, Bangladesh Phone:018XXXXXXXX ,E-mail: info@company.com ",
      link: "/emergency",
    },
  ];
  const ourAddress = [
    ...
    <footer className="footer-area text-white clear-both">
      <div className="container pt-5">
          ...
          <FooterCol key={4} menuTitle="" menuItems={ourAddress}>
            <ul className="social-media list-inline">
              <li className="list-inline-item">
                <a
                  style={{ height: "30px", width: "30px", borderRadius: "7px" }}
                  href="https://www.linkedin.com"
                >
                  <i
                    className="mx-2 fa fa-linkedin"
        ...
        <div className="copyRight text-center">
          <p className="text-white mb-0 pb-2">
            © Apartment Hunt &nbsp; {new Date().getFullYear()} , Bangladesh
          </p>
        </div>
      </div>
    </footer>
