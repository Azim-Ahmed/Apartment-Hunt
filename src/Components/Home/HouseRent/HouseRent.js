        ...
        {rentData.map((item) => (
          <Col className="my-3" lg={4} sm={12} md={{ size: 4, order: 1 }}>
            <Card style={{ borderRadius: "8px" }}>
              ...
              <CardBody>
                <CardTitle>
                  <h5 style={{ color: "#16322E" }}>{item.title}</h5>
                </CardTitle>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <Link
                    to={`/housedetails/${item.id}`}
                    style={{ textDecoration: "none" }}
                  >
                    <button className="text-white searchButton">
                      <a style={{ textDecoration: "none" }} href={item.github}>
                        View Detailes
                      </a>
                    </button>
                  </Link>
